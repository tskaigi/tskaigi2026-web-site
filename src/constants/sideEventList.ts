...
もちろん、「話を聞いてみたい」という方のご参加も大歓迎です。`,
  ...
  {
    date: "6/10 (水)",
    name: "TSKaigi Night talks ~after conference~",
    link: "https://findy.connpass.com/event/392420/",
    thumbnail:
      "https://media.connpass.com/thumbs/3f/37/3f3786a0a7637d6f15c6115385e7cd38.png",
    detail: `今年のTSKaigiはプロポーザルの倍率も非常に高く、惜しくも採択されなかった方々の中にも、熱量の高い知見が多くあると感じています。そうした知見をコミュニティの資産として還元し、当日参加できなかった方も含めて、みんなでTypeScriptコミュニティをさらに盛り上げられる場にしたいと考え、TSKaigi 2025のスポンサー企業9社の共催によるアフターイベントを開催いたします。`,
    sponsors: [
      "ファインディ株式会社",
      "株式会社UPSIDER",
      "MOSH株式会社",
    ...
    finishedAt: new Date("2026-06-11T00:00:00+09:00"),
  },
  {
    date: "6/12 (金)",
    name: "TSKaigi2026〜アフターパーティー〜",
    link: "https://every.connpass.com/event/393937/",
    thumbnail:
      "https://media.connpass.com/thumbs/eb/4c/eb4ccffeb61b6051418e8caf58a546a3.png",
    detail: `TSKaigi2026の余熱、まだまだ終わらせたくない！スポンサー・登壇企業であるウェルスナビ / スリーシェイク / PeopleX / 弁護士ドットコム / エブリーが集まり、LTと懇親会でわいわい盛り上がるアフターパーティーを開催します。参加した方も、参加できなかったけど雰囲気を味わいたい方も大歓迎。TypeScript / Frontendが好きな皆さん、ぜひお気軽にご参加ください！`,
    sponsors: [
      "株式会社エブリー",
      "ウェルスナビ株式会社",
      "株式会社スリーシェイク",
