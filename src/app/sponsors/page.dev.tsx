...
import type { SponsorPlan } from "@/types/sponsor-api";
...
const SponsorsPage = async () => {
  ...
  return (
    <main className="bg-blue-light-100 pt-16 py-10 md:px-8">
      ...
      <div className="bg-white p-6 flex flex-col gap-10 max-w-7xl mx-auto md:rounded-xl lg:p-10">
        {Object.entries(sponsors).map(([key, value]) => {
          return (
            <div key={key} className="flex flex-col gap-12">
              <SponsorHeading variant={key as SponsorPlan} />
